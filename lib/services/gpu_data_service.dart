  ...
  Future<List<GPUModel>> generateMockGPUData() async {
    ...
    final gpus = <GPUModel>[
      ...
      GPUModel(
        ...
        departmentName: null,
        userName: null,
        cloudMetadata: const CloudInstanceMetadata(
      ...
      // Tesla T4 GPU 추가 (비용 효율적인 추론용)
      GPUModel(
        id: 'Nvidia Tesla T4-GPU0',
        name: 'Nvidia Tesla T4-GPU0',
        avgUtil: 0,
        isMig: false,
        performance: const GPUPerformance(latency: 0, tps: 0),
        monthlyData: _generateTimeSeriesData(0, 31),
      ...
      GPUModel(
        id: 'Nvidia Tesla T4-GPU1',
        name: 'Nvidia Tesla T4-GPU1',
        avgUtil: 0,
        isMig: false,
        performance: const GPUPerformance(latency: 0, tps: 0),
        monthlyData: _generateTimeSeriesData(0, 31),
      ...
      GPUModel(
        ...
        userName: '박분석',
        cloudMetadata: const CloudInstanceMetadata(
          instanceId: 'i-0123456789abcdef5',
          instanceType: 'p4d.24xlarge',
          provider: CloudProvider.aws,
          region: 'us-east-1',
          gpuType: GPUType.a100_40gb,
      ...
      GPUModel(
        ...
        userName: '이모델',
        cloudMetadata: const CloudInstanceMetadata(
          instanceId: 'i-0123456789abcdef6',
          instanceType: 'p5.48xlarge',
          provider: CloudProvider.aws,
          region: 'us-east-1',
          gpuType: GPUType.h100,
      ...
      GPUModel(
        ...
        userName: '최비전',
        cloudMetadata: const CloudInstanceMetadata(
          instanceId: 'i-0123456789abcdef7',
          instanceType: 'p4de.24xlarge',
          provider: CloudProvider.aws,
          region: 'us-east-1',
          gpuType: GPUType.a100_80gb,
      ...
      GPUModel(
        ...
        userName: '정언어',
        cloudMetadata: const CloudInstanceMetadata(
          instanceId: 'i-0123456789abcdef8',
          instanceType: 'p5.48xlarge',
          provider: CloudProvider.aws,
          region: 'us-east-1',
          gpuType: GPUType.h100,
      ...
      GPUModel(
        ...
        userName: '강추천',
        cloudMetadata: const CloudInstanceMetadata(
          instanceId: 'i-0123456789abcdef9',
          instanceType: 'p4d.24xlarge',
          provider: CloudProvider.aws,
          region: 'us-east-1',
          gpuType: GPUType.a100_40gb,
      ...
      GPUModel(
        ...
        userName: '오강화',
        cloudMetadata: const CloudInstanceMetadata(
          instanceId: 'i-0123456789abcdefb',
          instanceType: 'p4de.24xlarge',
          provider: CloudProvider.aws,
          region: 'us-east-1',
          gpuType: GPUType.a100_80gb,
      ...
      GPUModel(
        ...
        userName: '한생성',
        cloudMetadata: const CloudInstanceMetadata(
          instanceId: 'i-0123456789abcdefc',
          instanceType: 'p5.48xlarge',
          provider: CloudProvider.aws,
          region: 'us-east-1',
          gpuType: GPUType.h100,
      ...
      GPUModel(
        ...
        userName: '조로봇',
        cloudMetadata: const CloudInstanceMetadata(
          instanceId: 'i-0123456789abcdefd',
          instanceType: 'p4d.24xlarge',
          provider: CloudProvider.aws,
          region: 'us-east-1',
          gpuType: GPUType.a100_40gb,
